...
void SkyTextureGenerator::_bind_methods() {
	ClassDB::bind_method(
		D_METHOD("generate", "albedo", "altitude", "elevation", "visibility", "resolution"), &SkyTextureGenerator::generate);
	ClassDB::bind_method(
		D_METHOD("read_dataset", "path", "single_visibility"), &SkyTextureGenerator::readDataset);
...
Ref<Image> SkyTextureGenerator::generate(
		double albedo,
		double altitude,
		double elevation,
		double visibility,
